...
public class FareCalculatorServiceTest {
	...
	@Tag("BIKE")
	@DisplayName("Controler que la méthode 'FareCalculator(Ticket ticket)' implémente une fonctionnalité de gratuité pour une durée de stationnement 'BIKE' inférieure ou égale à 30 minutes")
	@Test
	public void calculateFareBikeWithLessThanFreeHalfHourParkingTime() {
		Date inTime = new Date();
	...
	@Tag("CAR")
	@DisplayName("Controler que la méthode 'FareCalculator(Ticket ticket)' implémente une fonctionnalité de gratuité pour une durée de stationnement 'CAR' inférieure ou égale à 30 minutes")
	@Test
	public void calculateFareCarWithLessThanFreeHalfHourParkingTime() {
		Date inTime = new Date();
